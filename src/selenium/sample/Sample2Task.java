...
//         get third text of class "test" (should be "Test Text 4")
        ...
        List<WebElement> elementsWithClassTest = driver.findElements(By.className("test"));
        System.out.println(driver.findElements(By.className("test")).size());
        System.out.println("-----------------------");
        for (WebElement elementWithClass : elementsWithClassTest) {
            System.out.println(elementWithClass.getText());
        }

        System.out.println("-----------------------");
        System.out.println(driver.findElements(By.className("test")).get(2).getText());
        System.out.println(elementsWithClassTest.get(2).getText());
