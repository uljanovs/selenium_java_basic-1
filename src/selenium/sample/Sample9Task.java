...
//         * but loading text is seen instead   "Loading green..."
        ...
        assertTrue(driver.findElement(By.xpath("//*[contains(text(), ' Loading ')]")).isDisplayed());
//         * 3) check that both button
//         * and loading text is not seen,
//         * success is seen instead "Green Loaded"
        Thread.sleep(4500);
        assertFalse(driver.findElement(By.id("start_green")).isDisplayed());
        assertFalse(driver.findElement(By.xpath("//*[contains(text(), ' Loading ')]")).isDisplayed());
        assertTrue(driver.findElement(By.xpath("//h2[@id='finish_green']")).isDisplayed());
    }
...
//        0) wait until button to load green and blue appears
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[@id='start_green_and_blue']")));
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@id='start_green_and_blue']")));
