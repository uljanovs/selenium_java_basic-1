...
//        enter a number under "Number"
        driver.findElement(By.id("number")).sendKeys("123214");
...
//        check that text is not displayed
        assertFalse(driver.findElement(By.id("result_button")).isDisplayed());
...
assertEquals("You enterednumber: \"123214", driver.findElement(By.id("result_number")).getText());

//        check that the button "Clear Result" is clickable now
        assertTrue(driver.findElement(By.id("clear_result_button_number")).isDisplayed());
...
//        verify that current url is homepage
        ...
        assertFalse(base_url,driver.equals(driver.getCurrentUrl()));
